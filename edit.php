...
if(isset($_POST['update']))
{
	...
	$result = mysqli_query($mysqli, "UPDATE register SET name='$name',fname='$fname',number='$number',email='$email' WHERE id=$id");
  ...
  <div class="row">
      ...
      <label><b>Mobile Number</b></label></div>
	   ...
	   <div class="clearfix">
        ...
        <button type="update" name="update" class="signupbtn">Update</button>
      </div>
